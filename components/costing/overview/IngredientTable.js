        ...
        <TableContainer component={Paper} elevation={3} className='p-5 m-5'>
            ...
            <div className='flex flex-col p-3'>
                <div className='flex flex-row p-3'>
                    <div className='text-center basis-1/2 text-red-500 text-2xl'>Cost per Kg:  </div>
                    <div className='text-center basis-1/2 text-red-500 text-2xl'>{euro.format(1.73)}</div>
                </div>
                <div className='flex flex-row p-3'>
                    <div className='text-center basis-1/3 text-black-500 text-lg'>Subtotal: </div>
                    <div className='text-center basis-1/3 text-black-500 text-lg'>Weight: 35.048</div>
                    <div className='text-center basis-1/3 text-black-500 text-lg'>Total Cost: {euro.format(58.65)}</div>
                </div>
                <div className='flex flex-row p-3'>
                    <div className='text-center basis-1/3 text-black-500 text-lg'>Typical Process Loss: </div>
                    <div className='text-center basis-1/3 text-black-500 text-lg'>3.0%</div>
                    <div className='text-center basis-1/3 text-black-500 text-lg'>Weight After Loss: 33.996</div>
                </div>
            </div>
